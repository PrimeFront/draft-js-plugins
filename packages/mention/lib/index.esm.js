...
function addMention(editorState, mention, mentionPrefix, mentionTrigger, entityMutability) {
  ...
  var mentionReplacedContent = Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, "" + (mentionTrigger === firstMentionCharacter ? firstMentionCharacter : mentionPrefix) + mention.name, editorState.getCurrentInlineStyle(), entityKey);
