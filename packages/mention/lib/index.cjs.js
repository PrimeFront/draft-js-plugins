...
function addMention(editorState, mention, mentionPrefix, mentionTrigger, entityMutability) {
  ...
  var firstMentionCharacter = mention.name.charAt(0);
  var mentionReplacedContent = draftJs.Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, "" + (mentionTrigger === firstMentionCharacter ? firstMentionCharacter : mentionPrefix) + mention.name, editorState.getCurrentInlineStyle(), entityKey);
